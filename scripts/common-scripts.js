...
;(function($){
	$(function(){
        ...
        $("div.mobi-nav").click(function(){
            ...
            $("div.main-nav").slideToggle( 500 )
            $("div.mobi-close-btn").show()
            $(this).hide()

        });
        
        $("div.mobi-close-btn").click(function(){
    ...
    $(window).load(function(){
        // Begin common slider
        if ( $('#success-slider').length == 0 ) return false
        ...
        $('#success-slider .slider-info').each(function(){
            $(this).find('.slider-figure').parent().addClass('hasfigure')
        })
